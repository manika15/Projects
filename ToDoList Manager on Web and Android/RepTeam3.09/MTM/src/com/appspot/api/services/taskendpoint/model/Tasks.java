...
public final class Tasks extends GenericJson {
   ...
   * example, a request that returns a single {@link Tasks} would include the response headers,
   * while a request which returns an array of {@link Tasks}, would have a non-null response header
