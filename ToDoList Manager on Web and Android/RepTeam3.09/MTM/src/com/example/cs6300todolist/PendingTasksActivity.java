...
@TargetApi(5)
public class PendingTasksActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d ("Ji", "Inside Pending tasks list");
		...
		Log.d ("Ji", "Pending list before list adapter");
		final ListView toDoListView = (ListView) findViewById(R.id.pending_taskListView);
		...
		toDoListView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				PopupMenu popupMenu = new PopupMenu(PendingTasksActivity.this, view);
					...
					public boolean onMenuItemClick(MenuItem item) {
						if (item.getItemId() == R.id.edit_menu) {
							...
							Intent myIntent = new Intent(
									PendingTasksActivity.this,
									EditItemActivity.class);
							//                      myIntent.putExtra(
							//                            "com.example.cs6300todolist.userid",
							//                          userId);
							myIntent.putExtra(
									"com.example.cs6300todolist.userkey",
									userKey);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_priority:
			...
			final ListView toDoListViewp = (ListView) findViewById(R.id.pending_taskListView);
	...
	public void onAddTaskClick(View view) {
		...
		//   myIntent.putExtra("com.example.cs6300todolist.userid", userId);
		myIntent.putExtra("com.example.cs6300todolist.userkey", userKey);
		myIntent.putExtra("com.example.cs6300todolist.tab_index", 1);
		startActivityForResult(myIntent, 0);
	}
